...
local function onChildAddedTwo(Object) -- temp 2v2 fix
    if (not Object) then return end;
    if (Object.Name ~= "FNFEngine") then return end;
...
connections:add(PlayerGui.ChildAdded, onChildAddedTwo);
task.spawn(onChildAddedTwo, PlayerGui:FindFirstChild"FNFEngine")
