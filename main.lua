...
local Window = Library:MakeWindow({IntroText = tostring(SplashText),Name = "Friday Night Bloxxin' Autoplayer", HidePremium = true, SaveConfig = false})
...
local OffsetToggle = Folder:AddSlider({Name = "Hit offset", Min = -50, Max = 50, Default = -6, Color = Color3.fromRGB(255,255,255), Increment = 0.1, Flag = "ms" })
Folder:AddTextbox({Name = "above", Default = "-6", extDisappear = false, Callback = function(Value) OffsetToggle:Set(Value) end})
